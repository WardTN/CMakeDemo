...
Java_com_example_cdemo_MainActivity_callNativeStr(JNIEnv *env, jobject thiz, jstring str) {
...
Java_com_example_cdemo_MainActivity_stringMethod(JNIEnv *env, jobject thiz, jstring str) {
    const char *jnistr = env->GetStringUTFChars(str, 0);
...
JNIEXPORT jstring JNICALL
Java_com_example_cdemo_MainActivity_callNativeStrArray(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_cdemo_MainActivity_accessInstanceField(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_cdemo_MainActivity_accessStaticField(JNIEnv *env, jobject thiz) {
    jclass clz = env->GetObjectClass(thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_cdemo_MainActivity_accessInstanceMethod(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_cdemo_MainActivity_accessStaticMethod(JNIEnv *env, jobject thiz) {
    jclass clazz = env->GetObjectClass(thiz);
...
Java_com_example_cdemo_MainActivity_invokeConstructors(JNIEnv *env, jobject thiz) {
    jclass clazz = env->FindClass("com/example/cdemo/Animal");
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_example_cdemo_MainActivity_allocConstructors(JNIEnv *env, jobject thiz) {
    jclass clazz = env->FindClass("com/example/cdemo/Animal");
    jmethodID methodId = env->GetMethodID(clazz, "<init>", "(Ljava/lang/String;)V");
